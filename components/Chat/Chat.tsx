        ...
        >
          <div
            style={{
              ...
              alignItems: 'center',
              backgroundColor: '#2E396D',
            }}
          >
            {/* <Image alt="" src="/bk.jpeg" width={700} height={700} /> */}
          </div>
        </div>
          ...
          <>
            ...
            >
              {conversation.messages.length === 0 ? (
                <>
                  <div className="mx-auto flex w-[350px] flex-col space-y-10 sm:w-[600px]">
                ...
                <>
                  <div className="flex justify-center border border-b-neutral-300 bg-neutral-100 py-2 text-sm text-neutral-500 dark:border-none dark:bg-[#30416F] dark:text-neutral-200">
                  ...
                  <div style={{ marginTop: 0 }}>
                    {conversation.messages.map((message, index) => (
                      <ChatMessage
                        ...
                        isLastMsg={index === conversation.messages.length - 1}
                      />
                    ))}
                  </div>
                  {loading && <ChatLoader />}
